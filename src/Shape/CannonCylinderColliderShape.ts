import { ICylinderColliderShape, Physics3DColliderShape} from "../../libs/LayaAir";
import { CannonColliderShape } from "./CannonColliderShape";

export class CannonCylinderColliderShape extends CannonColliderShape implements ICylinderColliderShape {
