...
import { CannonPhysicsCreateUtil } from "./CannonPhysicsCreateUtil";
...
export class CannonPysiceManager implements IPhysicsManager {
   ...
   /** @internal */
    ...
    constructor(physicsSettings: PhysicsSettings) {
		...
		this._btDiscreteDynamicsWorld.defaultContactMaterial.contactEquationRelaxation = physicsSettings.contactEquationRelaxation;
		this._btDiscreteDynamicsWorld.defaultContactMaterial.contactEquationStiffness = physicsSettings.contactEquationStiffness;
    ...
    */
    ...
    setGravity(gravity: Vector3): void {
        ...
        this._btDiscreteDynamicsWorld.gravity.set(this._gravity.x,this._gravity.y,this._gravity.z);
    }
    ...
    addCollider(collider: CannonCollider): void {
        ...
        this._btDiscreteDynamicsWorld.addBody(collider._btColliderObject);
    ...
    removeCollider(collider: CannonCollider): void {
        ...
        this._btDiscreteDynamicsWorld.removeBody(collider._btColliderObject);
    ...
    addJoint(joint: ConnonJoint) {
		...
		if(joint instanceof CannonSpringJoint){
			...
			this._btDiscreteDynamicsWorld.addConstraint(joint._constraint);
		}
    ...
    removeJoint(joint: ConnonJoint) {
		...
		if(joint instanceof CannonSpringJoint){
			...
			this._btDiscreteDynamicsWorld.removeConstraint(joint._constraint);
		}
    }
